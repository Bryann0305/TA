...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('biaya-gudang.store') }}" method="POST">
                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('biaya_sewa') is-invalid @enderror currency-input" 
                                       ...
                                       value="{{ old('biaya_sewa') ? number_format(old('biaya_sewa'), 0, ',', '.') : '' }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('biaya_listrik') is-invalid @enderror currency-input" 
                                       ...
                                       value="{{ old('biaya_listrik') ? number_format(old('biaya_listrik'), 0, ',', '.') : '' }}" 
                                       placeholder="0" required>
                            </div>
                            @error('biaya_listrik')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control @error('biaya_air') is-invalid @enderror currency-input" 
                                       ...
                                       value="{{ old('biaya_air') ? number_format(old('biaya_air'), 0, ',', '.') : '' }}" 
                                       placeholder="0" required>
                            </div>
                            @error('biaya_air')
                                <div class="invalid-feedback">{{ $message }}</div>
