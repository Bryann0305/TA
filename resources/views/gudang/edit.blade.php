...
<div class="container">
    ...
    <form id="form-gudang-edit" action="{{ route('gudang.update', $gudang->Id_Gudang) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="Kapasitas" id="Kapasitas" 
                       class="form-control" 
                       value="{{ old('Kapasitas', $gudang->Kapasitas) }}" required>
            </div>
        </div>
        ...
        <div class="mb-3 position-relative">
            ...
            <input type="text" name="alamat" id="alamat" 
                   ...
                   value="{{ old('alamat', $gudang->alamat) }}" required>
            ...
            <input type="hidden" name="latitude" id="latitude" value="{{ old('latitude', $gudang->latitude) }}">
            <input type="hidden" name="longitude" id="longitude" value="{{ old('longitude', $gudang->longitude) }}">
        </div>

        <div id="map" class="mb-4 rounded border" style="height:400px;" data-initial-lat="{{ $gudang->latitude ?? -7.2575 }}" data-initial-lng="{{ $gudang->longitude ?? 112.7521 }}"></div>

        <button type="submit" class="btn btn-primary">
            <i class="bi bi-save me-2"></i> Update Gudang
        </button>
    </form>
</div>
@endsection
...
<script>
    ...
    function geocodeAddress(query) {
        ...
        // Nominatim bounded → Nominatim global → Photon global
    ...
    // Saat submit, sinkronkan lat/lng dengan alamat terakhir
    var formEl = document.getElementById('form-gudang-edit');
    if (formEl) {
